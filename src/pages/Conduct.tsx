      ...
      <Box mb={10}>
        <Stack marginTop={"0%"} alignItems={"center"}>
          ...
          <Typography>
            ...
            interacting with each other, whether in person, in writing, or in
            any other form of communication. By participating in our
            organization's activities, you agree to follow this Code of Conduct.
          </Typography>
          <br />
          <br />
          ...
          <ul>
            <li>
              <Typography>
                Be respectful and considerate towards all participants,
            ...
            <li>
              <Typography>
                Exercise discretion and professionalism in your interactions
                with others.
              </Typography>
            </li>
            <li>
            ...
            <li>
              <Typography>
                ...
                disability, race, ethnicity, age, religion, or any other
          ...
          <ul>
            ...
            <li>
              <Typography>
                Engaging in any form of discrimination, including but not
                limited to, discrimination based on gender, sexual orientation,
                disability, race, ethnicity, age, religion, or any other
                personal characteristic.
              </Typography>
            ...
            <li>
              <Typography>
                Disrupting the organization's activities, either intentionally
          ...
          <Typography>
            Using or distributing any form of illegal substance or engaging in
          ...
          <ul>
            <li>
              <Typography>
                Being asked to leave the organization's activities immediately
                and permanently.
              </Typography>
            </li>
            <li>
          ...
          <Typography>
            ...
            leadership. All reports will be treated seriously and will be
            handled with respect for the privacy of the individuals involved.
          </Typography>
          <br />
          <br />
          ...
          <br />
          <Typography>
            By participating in our organization's activities, you agree to
            follow this Code of Conduct. We are committed to providing a
            respectful, inclusive, and harassment-free environment for all
            participants and will not tolerate any behavior that violates this
            Code of Conduct.
          </Typography>
        </Stack>
      </Box>
